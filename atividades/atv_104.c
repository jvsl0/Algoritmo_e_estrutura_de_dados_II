...
// FUNCAO PRINCIPAL DA TAREFA: Consulta o topo da pilha sem remover (Top/Peek)
Feitico top(Pilha *p) {
    ...
    // Retorna os dados do topo sem alterar a estrutura da lista
    return p->topo->dados;
}
...
// Funcao para liberar toda a memoria da pilha usando pop
